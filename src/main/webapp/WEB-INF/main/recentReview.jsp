...
<tr><th><i class="fas fa-angle-right"></i> 최신등록된리뷰</th></tr>
	...
	<div id="reviews">
		 ...
		 <div class="review" style="border:1px solid #ff8000; margin-bottom:5px; margin-left:0px; border-radius: 5px; text-align:left; padding:10px; display:inline-block; width:1150px;">
